...
export const zhTW: Record<MessageKey, string> = {
  ...
  "app.versionFooter": "Grok v0.1.8 · MIT · 非 xAI 官方 · 姊妹專案 grok-go",
  ...
  "rules.title": "規則",
  "rules.showPanel": "顯示專案規則",
  "rules.hidePanel": "隱藏專案規則",
  "rules.empty": "找不到專案規則檔案",
  "rules.emptyHint":
    "在專案根目錄新增 AGENTS.md 或 CLAUDE.md，或在 .grok/ 下放置 rules。",
  "rules.pickHint": "從清單開啟規則檔以預覽或編輯。",
...
"media.loadError": "應用程式內無法載入此媒體。",
  ...
  "composer.controlHint": "模型與推理力度作用於目前對話。變更力度可能會重啟 Agent。",
  "composer.modelSwitchFailed": "無法在目前 Agent 上切換模型。",
  "composer.effortSwitchFailed": "無法套用推理力度。",
  "composer.access": "存取",
