...
"settings.prefsScope": "模型與權限記憶範圍",
  ...
  "settings.wallpaperDesc":
    "上傳自訂壁紙（JPEG/PNG/WebP、GIF 或 MP4/WebM）。靜態圖會壓縮後保存在本機；影片和 GIF 會作為動態背景播放。",
  "settings.wallpaperEmpty": "尚未設定自訂背景",
  "settings.wallpaperUpload": "上傳壁紙",
  ...
  "settings.wallpaper.err.video_too_large": "影片過大（最大 50 MB）。",
  ...
  "ext.mcp.note":
    "新增/移除會寫入目前 agent 設定（`GROK_HOME` / agent-home）。開關會在 soft-respawn 後注入已啟用的伺服器到下一對話。",
  "ext.enabled": "已啟用",
  "ext.disabled": "已停用",
  "ext.enableAll": "全部啟用",
  "ext.footnote":
  ...
  "ext.hooks.desc":
    "生命週期腳本位於 ~/.grok/hooks 與專案 .grok/hooks。此處可列表並開啟資料夾；請用編輯器修改檔案。",
...
"error.needTauri": "需要在 Tauri 視窗中選擇目錄",
  ...
  // Remote IM
  "settings.nav.remoteIm": "遠端 IM",
  "settings.remoteIm.sidebarAria": "遠端 IM 渠道",
