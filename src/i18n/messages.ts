...
"media.loadError": "Could not load this media in the app preview.",
  ...
  "composer.controlHint": "Model and effort apply to this chat. Effort may restart the agent process.",
  "composer.modelSwitchFailed": "Could not apply the model on the live agent.",
  "composer.effortSwitchFailed": "Could not apply reasoning effort.",
...
"media.loadError": "应用内无法加载此媒体。",
  ...
  "composer.controlHint": "模型与推理力度作用于当前会话。更改力度可能会重启 Agent。",
  "composer.modelSwitchFailed": "无法在当前 Agent 上切换模型。",
  "composer.effortSwitchFailed": "无法应用推理力度。",
  "composer.access": "访问",
