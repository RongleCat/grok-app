...
"error.needTauri": "Folder picker requires the Tauri window",
  ...
  "settings.remoteIm.allowExternal": "Allow LAN / public bind",
  "settings.remoteIm.allowExternalHelp": "Default is localhost only. Prefer a tunnel for public webhooks; enabling this listens on all interfaces.",
