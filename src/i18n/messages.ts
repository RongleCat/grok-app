...
const en = {
  ...
  "app.versionFooter": "Grok v0.1.8 · MIT · Unofficial · Sister project grok-go",
...
"error.needTauri": "Folder picker requires the Tauri window",
  ...
  "mirror.rotateLink": "Regenerate link",
  "mirror.rotateDone": "Link regenerated — scan the new QR code.",
  "mirror.allowWrite": "Allow phone to send",
  "mirror.readOnlyOn": "Read-only (safe)",
  "mirror.readOnlyHint": "Phone can view sessions but cannot send messages or approve tools until you allow writes.",
  ...
  "settings.remoteIm.err.needAllowFrom": "Add at least one allowed sender ID before enabling this channel.",
  "settings.remoteIm.field.allowFromRequired": "Required — messages from others are rejected until set.",
...
const zh: Record<MessageKey, string> = {
  ...
  "app.versionFooter": "Grok v0.1.8 · MIT · 非 xAI 官方 · 姐妹项目 grok-go",
...
"error.needTauri": "需要在 Tauri 窗口中选择目录",
  ...
  "mirror.rotateLink": "重新生成链接",
  "mirror.rotateDone": "链接已更新 — 请重新扫码。",
  "mirror.allowWrite": "允许手机发送",
  "mirror.readOnlyOn": "只读（安全）",
  "mirror.readOnlyHint": "手机可查看会话，但不能发送消息或批准工具，除非你允许写入。",
