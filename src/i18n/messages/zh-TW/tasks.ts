...
export const zhTWTasks = {
  ...
  "ops.title": "Agent 運維",
  "ops.hint": "跳到目前工作階段任務、多工作階段儀表板、工作階段看板或批次分派。計數僅來自 App 即時狀態。",
  "ops.destinations": "運維入口",
  "ops.dest.tasks": "任務面板",
  "ops.dest.tasksHint": "目前工作階段的工具呼叫與子代理",
  "ops.dest.dashboard": "Agent 儀表板",
  "ops.dest.dashboardHint": "忙碌工作階段艦隊檢視 — 聚焦或全部停止",
  "ops.dest.taskBoard": "工作階段任務看板",
  "ops.dest.taskBoardHint": "依狀態分欄的工作階段（需你處理 · 執行中 · 閒置 · 完成）",
  "ops.dest.batchAgents": "批次 Agent",
  "ops.dest.batchAgentsHint": "同一提示詞分派到多個已信任專案",
  "ops.meta.tasksNoSession": "未開啟工作階段",
  "ops.meta.tasksReady": "目前工作階段",
  "ops.meta.tasksIdle": "無執行中工具",
  "ops.meta.tasksRunning": "{n} 個執行中",
  "ops.meta.dashboardIdle": "無忙碌工作階段",
  "ops.meta.dashboardBusy": "{n} 個忙碌",
  "ops.meta.boardEmpty": "無工作階段",
  "ops.meta.boardReady": "{n} 個工作階段",
  "ops.meta.batchReady": "分派",
  "ops.empty.noSessions": "尚無工作階段",
  "ops.empty.noSessionsHint": "開始聊天後看板與儀表板才會有內容。各入口仍可開啟並顯示誠實空態。",
  "ops.empty.noBusy": "目前無忙碌工作階段",
  "ops.empty.noBusyHint": "此刻沒有串流輸出或等待授權。儀表板與看板仍可查看閒置工作階段。",
  "ops.tasksNeedSession": "請先開啟工作階段以顯示任務面板",
  ...
  "tasks.activity.stopAll": "停止全部忙碌對話",
  "tasks.activity.stopAllTitle": "停止全部忙碌對話（應用全域）？",
  "tasks.activity.stopAllConfirm": "將停止應用程式內 {n} 個忙碌對話，進行中的回合會被取消。這會停止整個工作階段，而不是目前聊天裡的單一工具。",
  "tasks.activity.stopAllDone": "已停止 {n} 個對話",
  "tasks.activity.stopAllPartial": "已停止 {ok} 個；{fail} 個失敗",
  "tasks.activity.stopAllEmpty": "目前沒有可停止的忙碌對話",
  "tasks.activity.stopAllAllFailed": "無法停止 {fail} 個對話",
  ...
  "tasks.noKill": "ACP 不支援依工具終止 — 取消本聊天請用輸入框停止本輪；任務面板 / 儀表板的「停止全部」會停止應用程式內全部忙碌對話。",
  "tasks.expand": "展開詳情",
  "tasks.collapse": "收合詳情",
  ...
  "dashboard.stopAllConfirm": "將停止應用程式內全部 {n} 個忙碌工作階段？此操作是全域的，不僅限於目前篩選或勾選結果。進行中的回合會被取消。",
