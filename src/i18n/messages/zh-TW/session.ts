...
export const zhTWSession = {
  ...
  "session.handoff": "發送到新任務",
  "session.handoffOk": "已開啟新任務，並寫入簡短交接說明",
  "session.handoffFailed": "無法把目前工作發到新任務",
  ...
  "session.exportTraceNoCli": "找不到 Grok Build CLI。請先安裝或在設定中設定 CLI 路徑後再試。",
