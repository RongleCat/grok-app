...
export const zhTWSettings = {
  ...
  "settings.streamStallSecondsDesc": "若一輪對話在該時間內無任何串流片段或工具活動，應用會先嘗試靜默收尾已真正結束的 Host 狀態，再提示「繼續等待 / 結束本輪」（預設 180）。仍有工具事件的長任務不會誤判為停滯。應用不會擅自結束你發起的任務——只有你點「結束本輪」才會停。",
  ...
  "settings.trayBusyBadgeDesc": "有 Agent 忙碌時，在 macOS Dock 角標（或其他平台系統匣提示）顯示忙碌工作階段數。關閉則清除角標。",
  "settings.trayBusyBadge.status.off": "角標已關閉 — Dock/系統匣計數已清除。",
  "settings.trayBusyBadge.status.idle": "目前無忙碌工作階段 — 角標保持空白。",
  "settings.trayBusyBadge.status.busy": "Dock/系統匣顯示 {n} 個忙碌工作階段。",
  ...
  "settings.sessionModeHelp": "獨立模式會話存在應用目錄；共用模式使用 CLI 主目錄，與終端機共用會話。兩種模式均可匯入 CLI 工作階段；獨立模式掃描的是 agent-home（不一定是 ~/.grok）。",
