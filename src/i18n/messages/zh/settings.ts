...
export const zhSettings = {
  ...
  "settings.filePathCardLabel": "文件路径卡片",
  "settings.filePathCardLabelDesc": "对话里文件卡片如何显示路径。鼠标移上去会立刻显示完整路径。",
  "settings.filePathCardLabel.basename": "只显示文件名",
  "settings.filePathCardLabel.original": "按原文显示",
