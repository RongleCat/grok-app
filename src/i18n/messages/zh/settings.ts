...
export const zhSettings = {
  ...
  "settings.storeApiKeysInKeychainDesc": "新配置默认开启：API 密钥使用系统凭据管理器。关闭后会以明文保存在应用数据目录。保留已有选择；官方登录仍使用 Grok Build 认证。",
  ...
  "settings.allowUnverifiedCliDesc": "默认阻止安装缺少发布方 SHA-256 校验和的 CLI。仅在明确接受未经校验的下载时开启；校验和不匹配始终阻止安装。",
