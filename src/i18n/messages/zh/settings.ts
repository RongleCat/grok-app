...
export const zhSettings = {
  ...
  "settings.appIconDesc": "选择程序坞与应用切换器显示的图标；重启后仍会保留。",
  "settings.appIcon.defaultBlack": "默认黑色",
  "settings.appIcon.defaultWhite": "默认白色",
  "settings.appIcon.pixelGlitch": "像素失真",
  "settings.appIcon.minimalLine": "极简线稿",
  "settings.appIcon.terminalCode": "终端代码",
  "settings.appIcon.whiteHole": "白洞",
  "settings.appIcon.restoreDefault": "恢复默认",
  "settings.appIcon.confirm": "确认修改",
  "settings.appIconError": "无法修改应用图标。",
