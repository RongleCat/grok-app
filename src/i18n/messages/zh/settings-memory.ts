...
export const zhSettingsMemory = {
  ...
  "settings.memoryEmbed.baseUrlDesc": "OpenAI 兼容的 embedding 根地址（硅基流动等）。写入 [memory.embedding] base_url，避免混合搜索打到聊天中转。仅独立 agent-home 可写。",
  "settings.memoryEmbed.baseUrlPlaceholder": "https://api.example.com/v1",
  "settings.memoryEmbed.apiKey": "Embedding API 密钥",
  "settings.memoryEmbed.apiKeyDesc": "embedding 接口密钥。保存后不再显示。仅独立 agent-home 可写。",
  "settings.memoryEmbed.apiKeyPlaceholder": "sk-…",
  "settings.memoryEmbed.apiKeyKept": "已保存密钥，输入新密钥才会替换",
