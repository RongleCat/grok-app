...
export const zhTasks = {
  ...
  "ops.title": "Agent 运维",
  "ops.hint": "跳转到当前会话任务、多会话仪表盘、会话看板或批量分发。计数仅来自 App 实时状态。",
  "ops.destinations": "运维入口",
  "ops.dest.tasks": "任务面板",
  "ops.dest.tasksHint": "当前会话的工具调用与子代理",
  "ops.dest.dashboard": "Agent 仪表盘",
  "ops.dest.dashboardHint": "忙碌会话舰队视图 — 聚焦或全部停止",
  "ops.dest.taskBoard": "会话任务看板",
  "ops.dest.taskBoardHint": "按状态分列的会话（需你处理 · 运行中 · 空闲 · 完成）",
  "ops.dest.batchAgents": "批量 Agent",
  "ops.dest.batchAgentsHint": "同一提示词分发到多个已信任项目",
  "ops.meta.tasksNoSession": "未打开会话",
  "ops.meta.tasksReady": "当前会话",
  "ops.meta.tasksIdle": "无运行中工具",
  "ops.meta.tasksRunning": "{n} 个运行中",
  "ops.meta.dashboardIdle": "无忙碌会话",
  "ops.meta.dashboardBusy": "{n} 个忙碌",
  "ops.meta.boardEmpty": "无会话",
  "ops.meta.boardReady": "{n} 个会话",
  "ops.meta.batchReady": "分发",
  "ops.empty.noSessions": "暂无会话",
  "ops.empty.noSessionsHint": "开始聊天后看板与仪表盘才会有内容。各入口仍可打开并显示诚实空态。",
  "ops.empty.noBusy": "当前无忙碌会话",
  "ops.empty.noBusyHint": "此刻没有流式输出或等待授权。仪表盘与看板仍可查看空闲会话。",
  "ops.tasksNeedSession": "请先打开会话以显示任务面板",
  ...
  "tasks.activity.stopAll": "停止全部忙碌会话",
  "tasks.activity.stopAllTitle": "停止全部忙碌会话（应用全局）？",
  "tasks.activity.stopAllConfirm": "将停止应用内 {n} 个忙碌会话，进行中的回合会被取消。这会停止整个会话，而不是当前聊天里的单个工具。",
  "tasks.activity.stopAllDone": "已停止 {n} 个会话",
  "tasks.activity.stopAllPartial": "已停止 {ok} 个；{fail} 个失败",
  "tasks.activity.stopAllEmpty": "当前没有可停止的忙碌会话",
  "tasks.activity.stopAllAllFailed": "未能停止 {fail} 个会话",
  ...
  "tasks.noKill": "ACP 不支持按工具终止 — 取消本聊天请用输入框停止本轮；任务面板 / 仪表盘的「停止全部」会停止应用内全部忙碌会话。",
  "tasks.expand": "展开详情",
  "tasks.collapse": "收起详情",
  ...
  "dashboard.stopAllConfirm": "将停止应用内全部 {n} 个忙碌会话？此操作是全局的，不仅限于当前筛选或勾选结果。进行中的回合会被取消。",
