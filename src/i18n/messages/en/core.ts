...
export const enCore = {
  ...
  "app.versionFooter": "Grok v0.2.30 · MIT · Unofficial · Sister project grok-go",
  ...
  "ui.errorBoundary.settingsBody": "Settings failed to render. Your saved settings are unchanged — retry or return to the workbench.",
