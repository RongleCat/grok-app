/** English messages — domain: agent-run Kanban (Orca-style) */
export const enKanban = {
  ...
  "kanban.searchPlaceholder": "Search worktrees, projects, or agents…",
  "kanban.filter": "Filter",
  "kanban.filterTitle": "Board filters",
  "kanban.showIdle": "Show idle agents",
  "kanban.column.needsYou": "Needs you",
  "kanban.column.working": "Working",
  "kanban.column.done": "Done",
  "kanban.column.idle": "Idle",
