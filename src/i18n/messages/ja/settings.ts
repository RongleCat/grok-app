...
export const jaSettings = {
  ...
  "settings.terminalFontHint": "推荐 Nerd Font 的 Mono 变体（JetBrainsMono Nerd Font Mono / JetBrainsMono NF），Starship Powerline 分隔符才能铺满单元格。留空使用内置 Nerd Font 回退栈。已打开的终端会实时应用字号/字体。",
