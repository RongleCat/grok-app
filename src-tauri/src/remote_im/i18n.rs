...
pub fn t(lang: &str, key: MessageKey) -> &'static str {
    ...
    match (locale, key) {
        ...
        (Locale::La, MessageKey::StopSignalSent) => "Signum sistendi missum est.",
        (Locale::La, MessageKey::NoInFlightTurn) => "Nulla vicis in cursu.",
        (Locale::La, MessageKey::NoAvailableProject) => {
            "Haec instantia nullum opus praesto habet. Mitte /p vel administratorem consule."
        }
        ...
        (Locale::Sa, MessageKey::StopSignalSent) => "विरामसङ्केतः प्रेषितः।",
        (Locale::Sa, MessageKey::NoInFlightTurn) => "प्रचलन्ती आवृत्तिः नास्ति।",
        (Locale::Sa, MessageKey::NoAvailableProject) => {
            "अस्यां प्रतिकृतौ कोऽपि प्रकल्पः न उपलब्धः। /p प्रेषयतु अथवा प्रशासकं सम्पर्कयतु।"
        }
...
mod tests {
    ...
    const ALL_TAGS: [&str; 17] = [
        "en", "de", "es", "fil", "fr", "id", "it", "ja", "ko", "la", "pt-BR", "ru", "sa", "ta",
        "uk", "zh", "zh-TW",
    ];
